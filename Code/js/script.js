    ...
    function applyParallaxEffect(scrollY) {
        ...
        if (_anchorsReady) {
            ...
            if (_rivusAnchor) {
                ...
                const anchorTop = wrapperVisualTop - _rivusAnchorHeight2 - _rivusAnchorGap2 + 28 + _rivusTouchMeet + _rivusAnchorBoxExtra + (_blocksRotated ? 12 : 0); // iPhone-Rotation: GESICHTEN-Grau 12px tiefer
